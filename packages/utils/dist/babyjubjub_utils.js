...
export class BabyJubJubUtils {
    ...
    privateToPublicKey(privateKey) {
        const publicKeyPoint = this.babyJub.mulPointEscalar(this.babyJub.Base8, privateKey); // A point on Baby Jubjub : C = (CX, Cy)
        return {
            x: this._uint8ArrayToBigInt(this.babyJub.F.fromMontgomery(this.babyJub.F.e(publicKeyPoint[0])).reverse()), // fromMontgomery because circomlibjs uses the Montgomery form by default, but we need the Twisted Edwards form in Noir
            y: this._uint8ArrayToBigInt(this.babyJub.F.fromMontgomery(this.babyJub.F.e(publicKeyPoint[1])).reverse()),
        };
    }
    ...
    exp_elgamal_encrypt(public_key, plaintext, isTest = false) {
        ...
        if (typeof plaintext === "number" &&
            ...
            const plain_embedded = this.babyJub.mulPointEscalar(this.babyJub.Base8, plaintext);
            const shared_secret = this.babyJub.mulPointEscalar([
                this.babyJub.F.toMontgomery(this._bigIntToUint8Array(public_key.x).reverse()),
                this.babyJub.F.toMontgomery(this._bigIntToUint8Array(public_key.y).reverse()),
            ], randomness);
            const C2P = this.babyJub.addPoint(plain_embedded, shared_secret);
            const C1 = {
                x: this._uint8ArrayToBigInt(this.babyJub.F.fromMontgomery(this.babyJub.F.e(C1P[0])).reverse()),
                y: this._uint8ArrayToBigInt(this.babyJub.F.fromMontgomery(this.babyJub.F.e(C1P[1])).reverse()),
            };
            const C2 = {
                x: this._uint8ArrayToBigInt(this.babyJub.F.fromMontgomery(this.babyJub.F.e(C2P[0])).reverse()),
                y: this._uint8ArrayToBigInt(this.babyJub.F.fromMontgomery(this.babyJub.F.e(C2P[1])).reverse()),
            };
    ...
    exp_elgamal_decrypt_embedded(private_key, C1, C2) {
        const shared_secret = this.babyJub.mulPointEscalar([
        ...
        return {
            x: this._uint8ArrayToBigInt(this.babyJub.F.fromMontgomery(this.babyJub.F.e(plain_embedded[0])).reverse()),
            y: this._uint8ArrayToBigInt(this.babyJub.F.fromMontgomery(this.babyJub.F.e(plain_embedded[1])).reverse()),
        };
    }
    add_points(P1, P2) {
        ...
        return {
            x: this._uint8ArrayToBigInt(this.babyJub.F.fromMontgomery(this.babyJub.F.e(Psum[0])).reverse()),
            y: this._uint8ArrayToBigInt(this.babyJub.F.fromMontgomery(this.babyJub.F.e(Psum[1])).reverse()),
        };
    }
    intToLittleEndianHex(n) {
