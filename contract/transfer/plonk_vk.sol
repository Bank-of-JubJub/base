...
library UltraVerificationKey {
    ...
    function loadVerificationKey(
        ...
        assembly {
            ...
            mstore(
                add(_vk, 0x80),
                0x0c1545069ab690375fcc8f948b0ca77804011d325a4db2478e5da2b51f870b2e
            ) // vk.Q1.x
            mstore(
                add(_vk, 0xa0),
                0x2137f6bfa96ef3259f155ec4c95b3b5d8a09e37bf514cd06e9aecd129d38be87
            ) // vk.Q1.y
            mstore(
                add(_vk, 0xc0),
                0x15889567c23213fb5b21cdd20156ae003c94a113a019d50b10a66311b275f82b
            ) // vk.Q2.x
            mstore(
                add(_vk, 0xe0),
                0x160a91aef69d6ac3175b9ad952ae8088e7a760c8d5235b078381c3ec50a3776c
            ) // vk.Q2.y
            mstore(
                add(_vk, 0x100),
                0x122d1ea409c1713bd4367426f196cf986fce56c51b13c8c6dadf982a08289471
            ) // vk.Q3.x
            mstore(
                add(_vk, 0x120),
                0x1a4c875bf36a0694d79352a245f6d97a11fb2cfe6b3b32b7e29cbc8a5e4d35c8
            ) // vk.Q3.y
            mstore(
                add(_vk, 0x140),
                0x1c2bc07e1aea1e67ca9348841d483de733f3a4d43c2d2254e2dd21eca7f83d58
            ) // vk.Q4.x
            mstore(
                add(_vk, 0x160),
                0x236115f9b374d5a901f67b707f2fb716a90535297573aae05493b10eb528c210
            ) // vk.Q4.y
            mstore(
                add(_vk, 0x180),
                0x2fe365b7c455df9a83048d73711283ece21bc7b48446db9c5845e38f1ab253fe
            ) // vk.Q_M.x
            mstore(
                add(_vk, 0x1a0),
                0x2056b14d21b7d528bfb2721b97dcdf24580dafffed9adbfac27381132d697b06
            ) // vk.Q_M.y
            mstore(
                add(_vk, 0x1c0),
                0x274c22b5ebe23bee81939db2155d4123ac05242b7f3f02521251872a22f3227d
            ) // vk.Q_C.x
            mstore(
                add(_vk, 0x1e0),
                0x14a8dc105e8ad6a0fae2822879140847b662c0aff9b7a3fc5fec3a782cea5c19
            ) // vk.Q_C.y
            mstore(
                add(_vk, 0x200),
                0x0564fc0d65b8f016b8c4b153fe62ce2f3c4304fc71388e5b9699a3fa994e9cd9
            ) // vk.Q_ARITHMETIC.x
            mstore(
                add(_vk, 0x220),
                0x1f023c2d143b216c3b543db5133ec88f82d65099d6fcf3772fe69e1a07dbaefb
            ) // vk.Q_ARITHMETIC.y
            mstore(
                add(_vk, 0x240),
                0x0d50ca4edd54685c4eeb7bcb7495f3d136018bd1fe84bb128b98b9f8c7515a31
            ) // vk.QSORT.x
            mstore(
                add(_vk, 0x260),
                0x2a5e33f84b42581b014088cbccdadd4bb4536ec65cee1e2c05967976bf0e6db5
            ) // vk.QSORT.y
            mstore(
                add(_vk, 0x280),
            ...
            mstore(
                add(_vk, 0x300),
                0x188fd5efdf37c4bbca15d3a11e2bc49709f1be733496d50954e993bb341e1222
            ) // vk.SIGMA1.x
            mstore(
                add(_vk, 0x320),
                0x0c32cdd872f098836161cd964acf5b14a6add437a8c934bdd55f3ee286ea99cb
            ) // vk.SIGMA1.y
            mstore(
                add(_vk, 0x340),
                0x0ad90e0f60200aca88fd887871b63a54c969ed3f3485e15ed497fd118fb0183d
            ) // vk.SIGMA2.x
            mstore(
                add(_vk, 0x360),
                0x04074a79e43483bdcd4a1bf49726a06c5e9b22c376709ead3e6fd5a6908e7828
            ) // vk.SIGMA2.y
            mstore(
                add(_vk, 0x380),
                0x17f9d17457bb6e8fa220381ff7261ac92eb435b28a62a86023b3316a2e7aedcb
            ) // vk.SIGMA3.x
            mstore(
                add(_vk, 0x3a0),
                0x242ccaaebac910ad99e5324aacd53835e0795cacab0695b05ca7fb2ae979d787
            ) // vk.SIGMA3.y
            mstore(
                add(_vk, 0x3c0),
                0x013249d1325cc0e2b0e160a8469bf7e83aee71a1e6babc667da275d997fedefb
            ) // vk.SIGMA4.x
            mstore(
                add(_vk, 0x3e0),
                0x210b05e48e7baae2bb9ed6211683e1b54d33fdaab0b0bc6b6b7517d137b189bc
            ) // vk.SIGMA4.y
            mstore(
                add(_vk, 0x400),
            ...
            mstore(
                add(_vk, 0x500),
                0x128bc0152f2f0ae5236635544138944b58dc6595074cea3c05fbfe7ee6eaf1a9
            ) // vk.TABLE_TYPE.x
            mstore(
                add(_vk, 0x520),
                0x226b1e3a609560af540541c637150c8b1c56bc3846e41e848f7b30008db6964d
            ) // vk.TABLE_TYPE.y
            mstore(
                add(_vk, 0x540),
                0x152b74ef8ea323fba3e097d036adbe87d5a68ddd42fbe95419dbb4959cfd8312
            ) // vk.ID1.x
            mstore(
                add(_vk, 0x560),
                0x0438b0fc6fe2627043345caade8255fcd32ececef1c9293c9f8a46bddcd795e3
            ) // vk.ID1.y
            mstore(
                add(_vk, 0x580),
                0x1825b17b2cf111198d5f71b5563b013838f74ff296e18c14d0a14f7c51a7145b
            ) // vk.ID2.x
            mstore(
                add(_vk, 0x5a0),
                0x1758ebf3dc14bdc7ab5af26da7c2a4d9d472056d43becb09ab398bfc4372b019
            ) // vk.ID2.y
            mstore(
                add(_vk, 0x5c0),
                0x18bc322fc4ada54c389c1720b7b1067e9b687e6755376a009a3dc6f4d544d921
            ) // vk.ID3.x
            mstore(
                add(_vk, 0x5e0),
                0x00fece1f172b3a3c514e611ff01ab20027579cebbf1837ad72907fa2a3791467
            ) // vk.ID3.y
            mstore(
                add(_vk, 0x600),
                0x270c23c01b7f6e2b05a5d3efce57ca56630050d8f4bbc6a1c92c48013dfbee12
            ) // vk.ID4.x
            mstore(
                add(_vk, 0x620),
                0x1edf67851e4ba15676300af065c8a27e61dbfc06f0cb5fe153bffe3b0b564516
            ) // vk.ID4.y
