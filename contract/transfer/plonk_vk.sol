// Verification Key Hash: eb6c67ca0056be2e843e93726d6a194977c883255a0d9f6acc2ed7c539cba234
...
library UltraVerificationKey {
    function verificationKeyHash() internal pure returns(bytes32) {
        return 0xeb6c67ca0056be2e843e93726d6a194977c883255a0d9f6acc2ed7c539cba234;
    }
    ...
    function loadVerificationKey(uint256 _vk, uint256 _omegaInverseLoc) internal pure {
        assembly {
            ...
            mstore(add(_vk, 0x80), 0x16ac8bd0332eb6b2540b97e3aa5ce94d4413d89433ca25738fbe171aba394e81) // vk.Q1.x
            mstore(add(_vk, 0xa0), 0x07caf227f9335ee7a77ffe26539c8d4e9e581e8f023e4b6517a8287ddac80f41) // vk.Q1.y
            mstore(add(_vk, 0xc0), 0x15b8b424bbaa300ecb32fc05da90458509b3a6a1bd4062d7eb4999e0aa0097fc) // vk.Q2.x
            mstore(add(_vk, 0xe0), 0x23f3ca04d3bbd376df0e312559c276f659b5f374142d14a02fc4cba980fb157f) // vk.Q2.y
            mstore(add(_vk, 0x100), 0x0595770852e2a3f42ea1093dfc62fb5fb627b62692bfe58e7105667284bd38a9) // vk.Q3.x
            mstore(add(_vk, 0x120), 0x056da67551dd860e07edeac5749acd43098862ed79ce7eb7ea20ddcc1fb2a125) // vk.Q3.y
            mstore(add(_vk, 0x140), 0x23d57dd0d98402ef734e9b7b72573cc27c80f2861acb6d207d42bcf22b851a80) // vk.Q4.x
            mstore(add(_vk, 0x160), 0x2ea9bce81771b97933fad9c8350dde8c38cb0bb2a73a92456bc046eb7681ded1) // vk.Q4.y
            mstore(add(_vk, 0x180), 0x2d4d55ac1afc2a63cb4f88d3628fa290541f3f1de3448a9921e6bd006f913ec1) // vk.Q_M.x
            mstore(add(_vk, 0x1a0), 0x2cc14cd1b775c71b7633c36a44a30769935f849c43539a72ad1ff0e55e94dc97) // vk.Q_M.y
            mstore(add(_vk, 0x1c0), 0x22937ba33284779b4ee8ed53a827f1cbbf3beeb66fd133446b294b2b1e19afe4) // vk.Q_C.x
            mstore(add(_vk, 0x1e0), 0x2d43003ed479aa7102c7428a0e41fde3360f3a855df14c7fad4d61597beb6a23) // vk.Q_C.y
            mstore(add(_vk, 0x200), 0x0cb5a1f06aee2778654c9cb070c5bb5deaca0ea278825af2553e810236fb0c70) // vk.Q_ARITHMETIC.x
            mstore(add(_vk, 0x220), 0x1ac43627fc69ec7d0d6f7da2b2ddd995eb35f7706ab79a6d0f184c8c6235effc) // vk.Q_ARITHMETIC.y
            ...
            mstore(add(_vk, 0x2c0), 0x25de6d2c7266c8bddf38534f27475b5e010673962d92212f7442e9c5ece62259) // vk.Q_AUX.x
            mstore(add(_vk, 0x2e0), 0x159122c7e4e7dfde7fbdf9a5fe236fa09c50f5fc608661687f5706c367bd91d8) // vk.Q_AUX.y
            mstore(add(_vk, 0x300), 0x127da7bd2f80601bf2ad11578936d77ec1048e3dcb87f30e61b6e77b272d4fe5) // vk.SIGMA1.x
            mstore(add(_vk, 0x320), 0x164ab3c72a7654500b1274e4c8ef503d931f871cabc8389aef78a617192e3e44) // vk.SIGMA1.y
            mstore(add(_vk, 0x340), 0x259020f96deb34b4c08c53c6ea2456064067e5a52aed32daf4a646e205335c52) // vk.SIGMA2.x
            mstore(add(_vk, 0x360), 0x053d9fb2bbdffa704c91d76b66a898fbca3b785f83b3cd9c243fa5688ef852e9) // vk.SIGMA2.y
            mstore(add(_vk, 0x380), 0x103a559417504aadb9891b9bedd83e65cc95afc14f9c5b1a67bf0b6d2020a0ba) // vk.SIGMA3.x
            mstore(add(_vk, 0x3a0), 0x2260b90093ba15069af89069e0e3921d2ab2d84132a1ebf9705dabe3924c77e5) // vk.SIGMA3.y
            mstore(add(_vk, 0x3c0), 0x074ce0d9dbe9e130a942cf0f294c3fe895f6ffe9394789beea4e6a23ecd1c69b) // vk.SIGMA4.x
            mstore(add(_vk, 0x3e0), 0x1f565468dfbb0520cce8a30189cfe20ea3d1f188db038e444d5528078b087963) // vk.SIGMA4.y
            ...
            mstore(add(_vk, 0x540), 0x243b412fb7a349b712ea2ff5029275d1ffa2876d80dfa2580e51b1a9cc46ad02) // vk.ID1.x
            mstore(add(_vk, 0x560), 0x0a461a5440723222766fcb0d5f9d8044242cb420bf00baea8cb219edb206e8fd) // vk.ID1.y
            mstore(add(_vk, 0x580), 0x1a4abb7e75b31e5e2795372cb8a888c8bbe2a134cd8d9c7185a3be7b4a37c788) // vk.ID2.x
            mstore(add(_vk, 0x5a0), 0x1eca258f0362bfbb21d97ee10e39d6f7b7ddb8529267c6c9ad7440236917d340) // vk.ID2.y
            mstore(add(_vk, 0x5c0), 0x12fdd4a3e98724e7de5b38b4d9d4e06c3875d517f3e3fefe85fce714b451db4b) // vk.ID3.x
            mstore(add(_vk, 0x5e0), 0x19da83dd02fb642613a1610d7d6eaea56d7f52929b3e3135d25140dbed445cb1) // vk.ID3.y
            mstore(add(_vk, 0x600), 0x06ce65c272b15f88c40f1126a585b5673eeffa5e0b9b3a52c49a518f7e9b31ee) // vk.ID4.x
            mstore(add(_vk, 0x620), 0x03f7e0db87c15e46837a8764ebaf3584f7355d6e9d9f40dd497bd06c73fe5cf1) // vk.ID4.y
