...
library UltraVerificationKey {
    function verificationKeyHash() internal pure returns (bytes32) {
        return
            0x29d38359e8847bbcf5d84e8acbf9c0cc020dd4c85712ee5136a3d6589f435653;
    }
    ...
    function loadVerificationKey(
        ...
        assembly {
            ...
            mstore(
                add(_vk, 0x80),
                0x0ab1425e2c59d80f7699eafeb259a5195822014d00b1ef78b7eefaf54f81c24f
            ) // vk.Q1.x
            mstore(
                add(_vk, 0xa0),
                0x18122be4228302c5dcf4d18d926f4c7001d990a84287ad2c02de4748b5f76337
            ) // vk.Q1.y
            mstore(
                add(_vk, 0xc0),
                0x0878d2fc971b0b714af2eb8fd8bcc9115af74cd43a4c72b8fcddeb97272a74f7
            ) // vk.Q2.x
            mstore(
                add(_vk, 0xe0),
                0x108927ff9d2c31c184da17dbae531acec80ad6d91ae40114f5d78e6f8316c711
            ) // vk.Q2.y
            mstore(
                add(_vk, 0x100),
                0x201c2c78d687f9c46c11c6fcfa0914de9d4ece1c5e8c7f7e5a4e72f7e8517341
            ) // vk.Q3.x
            mstore(
                add(_vk, 0x120),
                0x1a83f9d3d90b66a7e6f78e109d98c7291cd94f4987269ec549425edf952b77ff
            ) // vk.Q3.y
            mstore(
                add(_vk, 0x140),
                0x2bddbaef5de92eef81f1f314c545148bf17b3a3f031e6b137e15d70f902440de
            ) // vk.Q4.x
            mstore(
                add(_vk, 0x160),
                0x26c9b88bd420bca1247812e429dcf140f46d2d1bb24fe6d28ffa8ca68073b495
            ) // vk.Q4.y
            mstore(
                add(_vk, 0x180),
                0x240fa34c605dfe1edd6c5b5c421af24b8a2a141bcbd7e9136da191f11de80b23
            ) // vk.Q_M.x
            mstore(
                add(_vk, 0x1a0),
                0x1be56142e8efa4446fc4bd09fa20e2c564e752f15491856cbe6e0592f0209683
            ) // vk.Q_M.y
            mstore(
                add(_vk, 0x1c0),
                0x0dc39419cac187ef0cf812472d51565e33e84e0535c38476d4cf434ba050bdb5
            ) // vk.Q_C.x
            mstore(
                add(_vk, 0x1e0),
                0x24eeef0aaa4786150a986f6a25f5c324ad7d9b60cd54f20360fb90538b720d66
            ) // vk.Q_C.y
            mstore(
                add(_vk, 0x200),
                0x14441178ca7513aa9d5c04417b53f60014ace78b4b566a6b9b034494546dd1ab
            ) // vk.Q_ARITHMETIC.x
            mstore(
                add(_vk, 0x220),
                0x0a81c65c5a60453f345390b65a0aeb1d2adadb817229d428ac03fafa365c347d
            ) // vk.Q_ARITHMETIC.y
            mstore(
                add(_vk, 0x240),
                0x2312cf671f2a6c8c9aedf2ab39a6545d888bec5b503cc6e17c5628795f5b7f8b
            ) // vk.QSORT.x
            mstore(
                add(_vk, 0x260),
                0x1fe38823d987100968528b29707f1593b0797e24a093bd00518aa063ea111b70
            ) // vk.QSORT.y
            mstore(
                add(_vk, 0x280),
            ...
            mstore(
                add(_vk, 0x300),
                0x1c56597cc2075c5eaff87b1e5a4c54b4e1bc319a3ea57132c2deda9fa5752700
            ) // vk.SIGMA1.x
            mstore(
                add(_vk, 0x320),
                0x1c7164eff2e17f4279bafea912b688d5c50e894b0d26d808e5fcadbe9777e6b5
            ) // vk.SIGMA1.y
            mstore(
                add(_vk, 0x340),
                0x2fc0b284fbbcd255c89145328e2bfa0c96093ce1a11c081338f65deb1698ca20
            ) // vk.SIGMA2.x
            mstore(
                add(_vk, 0x360),
                0x2fbcdad34539b55514c44058b4fb4e2366d44273114ec7905f1325923572c878
            ) // vk.SIGMA2.y
            mstore(
                add(_vk, 0x380),
                0x1e26c560e23314c2b222443f760cd1f10ef2c9275e12100ef5d4eff039c9a869
            ) // vk.SIGMA3.x
            mstore(
                add(_vk, 0x3a0),
                0x239862bd78b8a508d9689e1f818cb46227bf90b7f7ed052dbcfc9c7c8334b247
            ) // vk.SIGMA3.y
            mstore(
                add(_vk, 0x3c0),
                0x29c1dbef2b522b3b3cf7400bb0463ff1752e5138dbcb3d5ad8709edb46b1ae67
            ) // vk.SIGMA4.x
            mstore(
                add(_vk, 0x3e0),
                0x18023632396385e65a5c20016fe820303907ef37bbaaf92921843800cd13f8e1
            ) // vk.SIGMA4.y
            mstore(
                add(_vk, 0x400),
                0x0153cf448ba93b36fb1a3e334bf985bb0e7f671d7ca657c2510b8b64fc1390ea
            ) // vk.TABLE1.x
            mstore(
                add(_vk, 0x420),
                0x0652d5f62437967a51f7f604f8274bd2d3b946ce89c72e43d52520c3964218ea
            ) // vk.TABLE1.y
            mstore(
                add(_vk, 0x440),
                0x007fc1b76eaddd115bf2b07aa9de92811a55b0e5fd5ff8ae0c9dc2d3dc12cc74
            ) // vk.TABLE2.x
            mstore(
                add(_vk, 0x460),
                0x2b0360fd5e0824f832aef7327db2d2ef03f7ebde15daf8ec220a994226945ae4
            ) // vk.TABLE2.y
            mstore(
                add(_vk, 0x480),
                0x0b7f2f921abdf05965e7e2e61ec35a51ef68d0289e22322f7762acba675c1719
            ) // vk.TABLE3.x
            mstore(
                add(_vk, 0x4a0),
                0x0166014fbfd0b94710674e2dfe3e12c7afaa55282cd731d68a7487d569b92a5f
            ) // vk.TABLE3.y
            mstore(
                add(_vk, 0x4c0),
            ...
            mstore(
                add(_vk, 0x500),
                0x2b5f731909e7bbb6184e58d410e9ee8518dcf7b2e5bed738d822846f90f82455
            ) // vk.TABLE_TYPE.x
            mstore(
                add(_vk, 0x520),
                0x09e17174f064f8b248628f3df2f7f03a49d49f384da2a63bfe54b9af995768bf
            ) // vk.TABLE_TYPE.y
            mstore(
                add(_vk, 0x540),
                0x217f9757711c1d99767754b7b49886857bf88843295ab05bb4bbf77e68206e60
            ) // vk.ID1.x
            mstore(
                add(_vk, 0x560),
                0x1db8110a9c560889ea369ba8d30cc4be31cb2558ea628a5deaa345331ee14709
            ) // vk.ID1.y
            mstore(
                add(_vk, 0x580),
                0x20a17211876b929a9484b78384d2c2dd83f2eca35450ef5cae804c52d988e135
            ) // vk.ID2.x
            mstore(
                add(_vk, 0x5a0),
                0x14bff73630b0fcea6298f909b52597e2202901481692aa7fbce3c35b6f617c46
            ) // vk.ID2.y
            mstore(
                add(_vk, 0x5c0),
                0x0a236ba9677af8da8e1aec0d9a8fb4d1e189384913a15193eaed234e79913831
            ) // vk.ID3.x
            mstore(
                add(_vk, 0x5e0),
                0x0b0c4ae56fcfe6f46c95c68b0568987fdac737d354361ac5b7be0f965d925c01
            ) // vk.ID3.y
            mstore(
                add(_vk, 0x600),
                0x2f7e59e7410df4ead5e0af7f4a0c7c510737aaf5bae0a3274c87fb83b74d799b
            ) // vk.ID4.x
            mstore(
                add(_vk, 0x620),
                0x1bfd787c7e16fa36d4fbd5038855a37149a81190a6d6dc9834fb370c0e921423
            ) // vk.ID4.y
