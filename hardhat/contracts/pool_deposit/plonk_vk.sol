// Verification Key Hash: 6289cddd5488ba1e3db2430a070dd1fdbd7aa2c6f142d78c211f5ab347d2d230
...
library UltraVerificationKey {
    function verificationKeyHash() internal pure returns(bytes32) {
        return 0x6289cddd5488ba1e3db2430a070dd1fdbd7aa2c6f142d78c211f5ab347d2d230;
    }
    ...
    function loadVerificationKey(uint256 _vk, uint256 _omegaInverseLoc) internal pure {
        assembly {
            ...
            mstore(add(_vk, 0x80), 0x270aac30994d0abff76025a21f3fa8c262127a15a3cb6a9caea4b3ca6a745b82) // vk.Q1.x
            mstore(add(_vk, 0xa0), 0x09c9f225bda9fc6e3d5c82a8e462654bf77e1a96ddc4339d96116b927668c79d) // vk.Q1.y
            mstore(add(_vk, 0xc0), 0x240c388bc0267c70160bbf47b42c59f311d2c7c07e6e92e9a351fa8d34118b85) // vk.Q2.x
            mstore(add(_vk, 0xe0), 0x106cf92d71f8d82f6ec17419f2de1173e629b83a76f733516a57a0a9b05df59b) // vk.Q2.y
            mstore(add(_vk, 0x100), 0x1b81fed6e1dabc5acdd3bf166a76cbff4c57789ef638842b0222993edfcd1e6b) // vk.Q3.x
            mstore(add(_vk, 0x120), 0x0afba53edef534672aebd643120cded1355a94c871e431c7b31cd9eb9b728c83) // vk.Q3.y
            mstore(add(_vk, 0x140), 0x3045c6efea3300fcaf67bb2f37645d7ffff49da321e949631745b10415e489a7) // vk.Q4.x
            mstore(add(_vk, 0x160), 0x2fd846d37082991fd4d1af644d67b4991b46b603b022b5c8388f550925831aac) // vk.Q4.y
            mstore(add(_vk, 0x180), 0x116620aeb45c404e56c30f1a5685818b1dfa5d13017fafb739b5cb921784161f) // vk.Q_M.x
            mstore(add(_vk, 0x1a0), 0x1600c3045682093f0720f3faab82a50f0612a15f1926cc392efba416e83cb2da) // vk.Q_M.y
            mstore(add(_vk, 0x1c0), 0x2a4ad03542eb0c6e65a528919044372ef7c5c2d22126e7bb2681683d361ab71f) // vk.Q_C.x
            mstore(add(_vk, 0x1e0), 0x0c9225ac8d7a1d4639837bb972044554b1dd23aba972f3d30837561e605611d7) // vk.Q_C.y
            mstore(add(_vk, 0x200), 0x2eb1d2b2517da0e4e12202c53484163f843f85980a217808ba0086e43194581e) // vk.Q_ARITHMETIC.x
            mstore(add(_vk, 0x220), 0x132311ad9a3dfc2aa6e74f0348b1487447d40f119a09cdd301a58eb63a385cb1) // vk.Q_ARITHMETIC.y
            mstore(add(_vk, 0x240), 0x0b7be2ff795200c9e222cfb9b1ec6cc3800796aef339c5528362428a796ed0f2) // vk.QSORT.x
            mstore(add(_vk, 0x260), 0x0c61cdaf8e970a100b3b6c44d65b0c6afe762179bf5b1345d588d057ad6774fe) // vk.QSORT.y
            ...
            mstore(add(_vk, 0x2c0), 0x274a7074e93de41072b746894d17113950376ee071b8a82a0ea4e0e25db02a54) // vk.Q_AUX.x
            mstore(add(_vk, 0x2e0), 0x011d91ed489fd87dd1bf21680b87a3aa68dbaf3599b3e7958f9b89c0968ad14f) // vk.Q_AUX.y
            mstore(add(_vk, 0x300), 0x06a153842c7358d158304a3005bda258589fad2fda5f150483758c74d51ad009) // vk.SIGMA1.x
            mstore(add(_vk, 0x320), 0x2857afca21130e8a128344613929f39d0c7907afe4bab32c9790887d7c1542be) // vk.SIGMA1.y
            mstore(add(_vk, 0x340), 0x2fa2ce7f1add6ce570c7b8e578193d7c26a15b7f9699f606bc17774132774b39) // vk.SIGMA2.x
            mstore(add(_vk, 0x360), 0x253cca224a4cd346570ab2277ac8dc55f85cd09fb07c41325832b6633093b3bd) // vk.SIGMA2.y
            mstore(add(_vk, 0x380), 0x26e4f35b2a108acc3be6e6424f81c02fb8d0f23592be53d9df36200ad1b19928) // vk.SIGMA3.x
            mstore(add(_vk, 0x3a0), 0x029ea1e0b7b71ef57906b58dd471f6d063f66bc526833e135a410984da230622) // vk.SIGMA3.y
            mstore(add(_vk, 0x3c0), 0x0ff7f63316616339603d8dc9e81f570e2738d102ef1bc933ddda956d995b1e01) // vk.SIGMA4.x
            mstore(add(_vk, 0x3e0), 0x1550d982f4ce69297618da076232c183fc842cb3835bb081e62ef3562b4aef9b) // vk.SIGMA4.y
            ...
            mstore(add(_vk, 0x500), 0x06847db5777e4a82669bcd05f3238dc1c67deac391e8c48b5717028f0106e166) // vk.TABLE_TYPE.x
            mstore(add(_vk, 0x520), 0x0d34ce7fe7dce469223d21cb112c8be2cb7c9f0622d97c075cb5a3a95786c04d) // vk.TABLE_TYPE.y
            mstore(add(_vk, 0x540), 0x1befdb511dbd08f1befce97b03ecba7630960c0811f94d8b83c6d01072f3445d) // vk.ID1.x
            mstore(add(_vk, 0x560), 0x0425895e29a7630a2c2877dff55c7c2cd5c7c6544f72f91e941912dd23f2c87f) // vk.ID1.y
            mstore(add(_vk, 0x580), 0x0fdbbd66e4a9e71b78eb043f756d39a679b6b58f425ef331e02b5024c9865f1f) // vk.ID2.x
            mstore(add(_vk, 0x5a0), 0x1bf26a7628d3206f37631f8631fe7afad9f78609bd857dd25885694cd5e1d927) // vk.ID2.y
            mstore(add(_vk, 0x5c0), 0x22196e7618b93050f73ea5300adb5878e0d8413a24997820df13f41702e0aa43) // vk.ID3.x
            mstore(add(_vk, 0x5e0), 0x0bdcb9dbc5ab1aae7abecb2bbfa7790b98b6c555fed3c89b6a1b13214c423318) // vk.ID3.y
            mstore(add(_vk, 0x600), 0x0aebd86384c9bbd42c8cb0f24172caa233aa192ac459a7e167e04d44488b2896) // vk.ID4.x
            mstore(add(_vk, 0x620), 0x0cb3202d1760d9f1aa8be086184243c9c1f16229e14a60ba78d393b139720c44) // vk.ID4.y
