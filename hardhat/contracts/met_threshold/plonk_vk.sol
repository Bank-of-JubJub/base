// Verification Key Hash: 913e2f7bc698b9e9ef10cdfca11c4534452a743c0685af5269bcccee88c1f23f
...
library UltraVerificationKey {
    function verificationKeyHash() internal pure returns(bytes32) {
        return 0x913e2f7bc698b9e9ef10cdfca11c4534452a743c0685af5269bcccee88c1f23f;
    }
    ...
    function loadVerificationKey(uint256 _vk, uint256 _omegaInverseLoc) internal pure {
        assembly {
            ...
            mstore(add(_vk, 0x80), 0x1cc329fc37467408bef646a863c5658abb959b4fc70dd84c02a1fddac07693c9) // vk.Q1.x
            mstore(add(_vk, 0xa0), 0x168c4b5599d814134d61560b2fb2bdacea8520ed74f9098047df8a94e4d78fcc) // vk.Q1.y
            mstore(add(_vk, 0xc0), 0x27d9fa945975da3e283630a0e3969bfd6d996efc441fa2b6c40b362a3d290242) // vk.Q2.x
            mstore(add(_vk, 0xe0), 0x24573b3f64fb9a4e20e4ebbeaf7c0afff494f23dca7f4c13b672da6bad43a1d7) // vk.Q2.y
            mstore(add(_vk, 0x100), 0x2931b46f0dbd93d0bd637327b07c0594c61f2d0ce4a6cbf65716a2d0245e6055) // vk.Q3.x
            mstore(add(_vk, 0x120), 0x1f0e911830a38f5b4a49d0cf06924e8171be8298177d205963971334ea93881e) // vk.Q3.y
            mstore(add(_vk, 0x140), 0x29f55069c70dc85031d84bafb4036eaadf973385f84c30650444676c3d0c158d) // vk.Q4.x
            mstore(add(_vk, 0x160), 0x0cf1ac3319e484c52f117a0cb8743370b906852991d5a5b77f31551d5a83a3ee) // vk.Q4.y
            mstore(add(_vk, 0x180), 0x2aefb4603f5e9ed2ff10ddae79ac33f8d8b6ce51d922272a948a88519b7ab9d2) // vk.Q_M.x
            mstore(add(_vk, 0x1a0), 0x16a61d209b51ba65eef7f81629885a9aef445004a6d263ca2463f16ddaa1b8e1) // vk.Q_M.y
            mstore(add(_vk, 0x1c0), 0x20b04a005158a4763fe4b2316f66781e83c8c3c753faadc200d4f0b07d4a4a5f) // vk.Q_C.x
            mstore(add(_vk, 0x1e0), 0x005a253260cc5eeee315b5109a13e215ddeb4f8c1d772ce388e19c987b90b52a) // vk.Q_C.y
            mstore(add(_vk, 0x200), 0x0e72cfee0801bf6ee3c8de2e02e619ae62cc52e072f2d1b6dc0cd71950887ee6) // vk.Q_ARITHMETIC.x
            mstore(add(_vk, 0x220), 0x0f023feed60d7eb0dd6cc3082196d15d182bcd39f3146c59df6eb10e0bcaa171) // vk.Q_ARITHMETIC.y
            mstore(add(_vk, 0x240), 0x058f7863ea47c2200b3edd3f131668017ba36f1275cc9d41be13821c7633992b) // vk.QSORT.x
            mstore(add(_vk, 0x260), 0x14425b626a46728ab5a818b204a5744f581b674eec3360cf3ecc391bdfe4230e) // vk.QSORT.y
            ...
            mstore(add(_vk, 0x300), 0x1c84dc63761e5e881406e945fa76688750394de15ad236c4a09effb2f71c0b31) // vk.SIGMA1.x
            mstore(add(_vk, 0x320), 0x2c02b6c38274e994dd401e6bce999eea34d7669e68028742b1a2c2c276896a54) // vk.SIGMA1.y
            mstore(add(_vk, 0x340), 0x1362134813cfc99f0e020ab7d945eae06e14d6360b58380f915c3f4c850d3825) // vk.SIGMA2.x
            mstore(add(_vk, 0x360), 0x033ce932246ad942296d3f246ee336a4497b3b1b73d4814726175004bfd9b733) // vk.SIGMA2.y
            mstore(add(_vk, 0x380), 0x0a276cca927a8708f537aa105c4959f2052eda0e351a97e58187d3f3cf9236f8) // vk.SIGMA3.x
            mstore(add(_vk, 0x3a0), 0x1ffb65a0d926529986cdb1ea635915f85f1e927c711dda46eee3d28aacdc92f1) // vk.SIGMA3.y
            mstore(add(_vk, 0x3c0), 0x2c39db840a67fddee811cb2c5744d39fc238c38ce5091dc5a7614a8d6bbacc15) // vk.SIGMA4.x
            mstore(add(_vk, 0x3e0), 0x00af92a5c0c9a6988067a8b46fc345fa6e910a02ca022d2aa34227d4027663a3) // vk.SIGMA4.y
            ...
            mstore(add(_vk, 0x540), 0x0fddc7d8452ed2b810da1bbc34dfa138138604ce5a555f18766aafa0ef041863) // vk.ID1.x
            mstore(add(_vk, 0x560), 0x13e1f6b10ba2cebba16583d516bca07d216fe27ef87916c94241955e417a5da5) // vk.ID1.y
            mstore(add(_vk, 0x580), 0x06a4081f0b937fc2f0ed6393af70d906dc24863c8503b571add71dc8aab43255) // vk.ID2.x
            mstore(add(_vk, 0x5a0), 0x2d03362b0f0b68cc3d108484d9b52274dab605d1ef2b5a614cef1902989a5e6c) // vk.ID2.y
            mstore(add(_vk, 0x5c0), 0x2110c1079c30140459fef7405cacb20cc56bc30d6a2ee1d97452bc5f4df96719) // vk.ID3.x
            mstore(add(_vk, 0x5e0), 0x14d709034ea9388269c6f50d765df5e8eddf392f94b18de145687a4d8e961f22) // vk.ID3.y
            mstore(add(_vk, 0x600), 0x0c77d51bfbaa55e510885620eb05d69afc40ea7ebc2066052d90e0b59bce01b8) // vk.ID4.x
            mstore(add(_vk, 0x620), 0x2e2c35fe0ca4b2ca0e07d14f0669c0564232da54c1656b99e98123e181446cb0) // vk.ID4.y
