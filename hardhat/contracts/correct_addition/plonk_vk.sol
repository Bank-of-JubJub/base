// Verification Key Hash: f204b96835b257206c76cb40f487efe46b6b006bd00c1c049a648a6c18c0f550
...
library UltraVerificationKey {
    function verificationKeyHash() internal pure returns(bytes32) {
        return 0xf204b96835b257206c76cb40f487efe46b6b006bd00c1c049a648a6c18c0f550;
    }
    ...
    function loadVerificationKey(uint256 _vk, uint256 _omegaInverseLoc) internal pure {
        assembly {
            ...
            mstore(add(_vk, 0x80), 0x21db189a15ae109bba6de7f7305035d0473c221582661f0467c412a32222e220) // vk.Q1.x
            mstore(add(_vk, 0xa0), 0x2d1a32058355615d5e77d607e92a31aa5cc863f2717e5c21f72c6e5adf5821d1) // vk.Q1.y
            mstore(add(_vk, 0xc0), 0x19f13e082f97f9324fed1e97f9bb45fad3a45580851164c3b62e817fc00e6bed) // vk.Q2.x
            mstore(add(_vk, 0xe0), 0x096447ee5d05bc6a8acbbd2f695818afeb54417d6989c58d5250415bf55e94e2) // vk.Q2.y
            mstore(add(_vk, 0x100), 0x230d4cf6458cdaadf8535f0acec687576baea71f0de8bb291e26663376c8f5cb) // vk.Q3.x
            mstore(add(_vk, 0x120), 0x20144697155cac2f27747a2a87bb71da4e4e8dc3262394f37847f7185395f20c) // vk.Q3.y
            ...
            mstore(add(_vk, 0x180), 0x1ea8447c71d00d6489fc2b89f54b7baca321c9e2961f7f47a3b55626a8c8ba54) // vk.Q_M.x
            mstore(add(_vk, 0x1a0), 0x22ea1a633714375c9ed53126d541e95127bfe180bbf4a1f989ade96e705c8ee3) // vk.Q_M.y
            mstore(add(_vk, 0x1c0), 0x106f46656f462232793f4e774efd8d7b03b7128e24a5b1384409be3f7d7a6b94) // vk.Q_C.x
            mstore(add(_vk, 0x1e0), 0x1237222f3ee49e28db208db2117a37f6565852c8dac5be6e88620cdc352c0199) // vk.Q_C.y
            mstore(add(_vk, 0x200), 0x04481721afa974db4d647b24936b88ee6547cfe892f2b350c0e2fe1929a2cc79) // vk.Q_ARITHMETIC.x
            mstore(add(_vk, 0x220), 0x2edda53392db4b450b55c10d238e07170372c0dd16325844e4796ee3e1c981a5) // vk.Q_ARITHMETIC.y
            ...
            mstore(add(_vk, 0x300), 0x1059080b5ed93073af2cb9a3f57f8f12e60794b67b1bc1de39ba0b9ca973772d) // vk.SIGMA1.x
            mstore(add(_vk, 0x320), 0x29f732deea600a0267aac6f6462a22b6d28239ed9948bc67e185477fdab70144) // vk.SIGMA1.y
            mstore(add(_vk, 0x340), 0x2983de8fe6008b0437bb5c48cc22076b486d8794a2a592d1c440d082cde985c6) // vk.SIGMA2.x
            mstore(add(_vk, 0x360), 0x01ba369838b9af60fb5570a4ab1a6e4b6a5d7f19ea4e9d8d768713a891498d1d) // vk.SIGMA2.y
            mstore(add(_vk, 0x380), 0x29f87c171c87e2934cfabe638d141969a6a66d60177d0f37996142b976278e95) // vk.SIGMA3.x
            mstore(add(_vk, 0x3a0), 0x03d584c3291f054e00b7f1e9486341f2fccf460c8187a1a6c13874822c65ce1e) // vk.SIGMA3.y
            mstore(add(_vk, 0x3c0), 0x266384f299be59d6483e386deb5095894c9315f250ea0822c2893a2e21c9ab51) // vk.SIGMA4.x
            mstore(add(_vk, 0x3e0), 0x23d497298593bd9aa361cef00da71a7b8afbeedc69ac97740d53cd3a594ae622) // vk.SIGMA4.y
            ...
            mstore(add(_vk, 0x540), 0x19a7b281c5b09025bca5910ef27300294442800c30812e77ac1994b2e54462f4) // vk.ID1.x
            mstore(add(_vk, 0x560), 0x02e5a7ac2e26750128673ce030e5082408265c219deaa882bb608024f89fac4e) // vk.ID1.y
            mstore(add(_vk, 0x580), 0x03937eba3a9766e0a95f22925fe3b98608f5fa2bd3bdd17a2a759391e5182f13) // vk.ID2.x
            mstore(add(_vk, 0x5a0), 0x17c219b72a40579e96608fbb13f3e4381ed9c9cf02909b53b54e3ab508dafc0d) // vk.ID2.y
            mstore(add(_vk, 0x5c0), 0x065fcaeeef187d4007cdd3657b4e292f07139117de30b0c1801d04d53c66b3e5) // vk.ID3.x
            mstore(add(_vk, 0x5e0), 0x0f4f37be2eaa3042b6414b4eb7f8f49dff51cc8ef5c55f208474fec59a447b99) // vk.ID3.y
