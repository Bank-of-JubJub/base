// Verification Key Hash: da3ad5f1b1dcbe9e095903cc1094c2734a22f5c4aec99d57fc8b337441cca815
...
library UltraVerificationKey {
    function verificationKeyHash() internal pure returns(bytes32) {
        return 0xda3ad5f1b1dcbe9e095903cc1094c2734a22f5c4aec99d57fc8b337441cca815;
    }
    ...
    function loadVerificationKey(uint256 _vk, uint256 _omegaInverseLoc) internal pure {
        assembly {
            ...
            mstore(add(_vk, 0x80), 0x1339d7c75038ca3f06b7361e9eb41d5f0b796b11087e5ce7eec9bb8f0aa8620d) // vk.Q1.x
            mstore(add(_vk, 0xa0), 0x08b3de589dffe00b963d5083fbe7b93741ca80cfca4939fd1ddc456a173335d0) // vk.Q1.y
            mstore(add(_vk, 0xc0), 0x0f8275de935d555c1bf42c458bedb3c5270bcc02f09d8d20f773e5ea208cf9b9) // vk.Q2.x
            mstore(add(_vk, 0xe0), 0x0955f14c426c304ce2628a564be4eda36e8013847d40ad8db8aa018f990d9774) // vk.Q2.y
            mstore(add(_vk, 0x100), 0x0f82e299806b8aa49cac92d20a1afb5f81f0c9175885f3f24ad76cf860806a85) // vk.Q3.x
            mstore(add(_vk, 0x120), 0x108a4471d10656daef539952f20f25f9e9f065610edf825dc71ada45c89e8738) // vk.Q3.y
            mstore(add(_vk, 0x140), 0x2fe00b8fb4afe31dd0974964e12df35d82c73ba3eed6ed6866e7390d97279097) // vk.Q4.x
            mstore(add(_vk, 0x160), 0x14a4c41a8d60c6c368c72eb2835859eb4acf15fa1429de68ab44b6671c0a032e) // vk.Q4.y
            mstore(add(_vk, 0x180), 0x149e23200b6cf6ab44bd5ed1e6e1bc1a82dfb3ca81bc9f52aacb0f1cd779b0f8) // vk.Q_M.x
            mstore(add(_vk, 0x1a0), 0x28b67fa8aa97fd2161e23a58b00f347b35a994e555387272830814a6dc51a26d) // vk.Q_M.y
            mstore(add(_vk, 0x1c0), 0x078dfcdf9c4910ffa739c079b680d6fa953f144cf3f6ff9b71f6dafd0396937f) // vk.Q_C.x
            mstore(add(_vk, 0x1e0), 0x1611c4b573b599941a81ffd6ba694ad9e03e6d93695678cc81be40ae80a28aa1) // vk.Q_C.y
            mstore(add(_vk, 0x200), 0x279bc859c2a2c8300bfb014e2204edae7efeb188fb3249269b7d287896866e13) // vk.Q_ARITHMETIC.x
            mstore(add(_vk, 0x220), 0x2d312a1583c18faa393dd832afaf964bf7a06348be266a57e3b6f95aec212ae7) // vk.Q_ARITHMETIC.y
            mstore(add(_vk, 0x240), 0x03ac0f14e1e7f56a48b2b59415623315118f27be5a89139a158a3c46705b87c7) // vk.QSORT.x
            mstore(add(_vk, 0x260), 0x1fe45e7f73673340dacae661632973613a0d2ea92b200cfb4f4c9cc0656960a3) // vk.QSORT.y
            ...
            mstore(add(_vk, 0x2c0), 0x19f1e19abf00171303785e41c768d2920db607c5f5fc125177ffb1c17a7c5b75) // vk.Q_AUX.x
            mstore(add(_vk, 0x2e0), 0x0b7f750948e76f0ab26171e3deb25a4d8b0a241bfe2d456580c5ca4652d18e3c) // vk.Q_AUX.y
            mstore(add(_vk, 0x300), 0x00c41d870f75f41016f4532441031a9c1acaadd1d41bd3e90d084d5c02f061e3) // vk.SIGMA1.x
            mstore(add(_vk, 0x320), 0x0c484d66aec1fdbf9600e769de5479ae6b87038e89a774f99fe8c2dae50128d5) // vk.SIGMA1.y
            mstore(add(_vk, 0x340), 0x1d7db6793031f5ee7156183c1fb87c4793fd23efdd5a1abde18d42c8e6728c95) // vk.SIGMA2.x
            mstore(add(_vk, 0x360), 0x129e6a4e591c7e172c164399eb43fcf686d4a3b117af203f3393b893c7804b5f) // vk.SIGMA2.y
            mstore(add(_vk, 0x380), 0x027be2fcdf68de0ab1225529f3679460fe03871b84875332ecc4fe0e6fc68fed) // vk.SIGMA3.x
            mstore(add(_vk, 0x3a0), 0x00a36d0ed1ed820d475fb780b85e905766243259ec4a2e8fa451a7240f1401c9) // vk.SIGMA3.y
            mstore(add(_vk, 0x3c0), 0x2ef8794a13819a278c1efa4202b0a6b6b5f51a1e3995df2a852dd064e2b6ab04) // vk.SIGMA4.x
            mstore(add(_vk, 0x3e0), 0x2a9b4924af659093fa204259b985ab61974005998ce09c326034f4bdaa769ffa) // vk.SIGMA4.y
            ...
            mstore(add(_vk, 0x500), 0x13a76824acbc32e89ab52a8de8890667bf46d3bb9ef06b651f265a96ca62e21e) // vk.TABLE_TYPE.x
            mstore(add(_vk, 0x520), 0x05d801a3a966e5f8de392ade9735ff90b998c126bfe474ada6cc9c572344f900) // vk.TABLE_TYPE.y
            mstore(add(_vk, 0x540), 0x280d5604a1e7d1a2b546ef94ffcc850693165f8e1c8d0dbb649b0a3996cf99de) // vk.ID1.x
            mstore(add(_vk, 0x560), 0x0c906b62bed37c5d20569613d71ddbfc4ce1f329a7a314396aa0bb5b1399ceaf) // vk.ID1.y
            mstore(add(_vk, 0x580), 0x0707fa34401dab190318562804d6ee68b112aba7fb7e65dcd8e1a22da0bbadb5) // vk.ID2.x
            mstore(add(_vk, 0x5a0), 0x1f14b50c794fb6aaebe9fb4046f085e6351e5a85a6e8c8af0f9094b68d9e4308) // vk.ID2.y
            mstore(add(_vk, 0x5c0), 0x0d90cd92396da8ece27d17e2d33913a940dbc12b3254c4abb4b0dd14384c5982) // vk.ID3.x
            mstore(add(_vk, 0x5e0), 0x0be9c7917de4081016dcb6c3d4327abbf17808f07f696b2916b92ae7eee72cf9) // vk.ID3.y
            mstore(add(_vk, 0x600), 0x1ad70af22eddf6c2fac6498c87a6dabcf751d4bf333a72d5f8bc1ee5f1ab704a) // vk.ID4.x
            mstore(add(_vk, 0x620), 0x0deb0e9d32eb4628eeb604aac0ea37a553dcdfc82bb97b31bdfdd3327e553b5d) // vk.ID4.y
