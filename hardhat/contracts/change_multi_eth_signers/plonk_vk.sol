// Verification Key Hash: 52e3d2c0b58c269521f0fcb8c5aff29ff80c749a494dd2ee132cf8954a8fe98e
...
library UltraVerificationKey {
    function verificationKeyHash() internal pure returns(bytes32) {
        return 0x52e3d2c0b58c269521f0fcb8c5aff29ff80c749a494dd2ee132cf8954a8fe98e;
    }
    ...
    function loadVerificationKey(uint256 _vk, uint256 _omegaInverseLoc) internal pure {
        assembly {
            ...
            mstore(add(_vk, 0x80), 0x0111b7fd16a3d04db2b8ab2c0263d1a862878ddb95dadb68cbd9d9bd2dcf8d60) // vk.Q1.x
            mstore(add(_vk, 0xa0), 0x1507738ce4b67b8d5c0c872611c268793c50772d631944f07729fc3a0a448bd3) // vk.Q1.y
            mstore(add(_vk, 0xc0), 0x2389bc6d972e2b180bdb2e4fe04da31b3a9a4d0dc34db109ce54f08a0e75a08e) // vk.Q2.x
            mstore(add(_vk, 0xe0), 0x1e979910ec0359294bdc34f75aeffe9014c1a910d9b90558d4e588fece85eb9c) // vk.Q2.y
            mstore(add(_vk, 0x100), 0x2af864a053d3a21e627349202b844e743d905b664bfb2f73ddd5a5c2326f2db2) // vk.Q3.x
            mstore(add(_vk, 0x120), 0x0ed10ae8c4f9bc57ecc0bc03d6ff22da5d4bf7fb87854512e8f3974d0d988114) // vk.Q3.y
            mstore(add(_vk, 0x140), 0x28e41dac57115f75cf97d4a26aa09c350eb59e8d5a0938ebfaa4921564f30770) // vk.Q4.x
            mstore(add(_vk, 0x160), 0x23db271f0dee2926e7ac6637fb9a7de078cabd616094e5a45b88e787c2cbe3bd) // vk.Q4.y
            mstore(add(_vk, 0x180), 0x11d461d6ac9b8ef2083b0f5f1ceee8fb82393a05e45d1c7cc493459e643f950d) // vk.Q_M.x
            mstore(add(_vk, 0x1a0), 0x191aeedec8f1db64d88436ca16e81b835e09d04ea31166dae6e049b780b330c5) // vk.Q_M.y
            mstore(add(_vk, 0x1c0), 0x17012543125b7f49ca91de2418c83c18adaac1ac7b99b640385e5b03edb60ee5) // vk.Q_C.x
            mstore(add(_vk, 0x1e0), 0x0e9f6b5e6cc7d440737325a84815687b179dfb34d850366d78f8e74a4836f69b) // vk.Q_C.y
            mstore(add(_vk, 0x200), 0x0e989916faca6b6928f13ea6e09c3494fde8ccbb9e29ca1c05eeeb898d8a82f1) // vk.Q_ARITHMETIC.x
            mstore(add(_vk, 0x220), 0x0a5c20d707e2320b6901b3eab7b5b3260289241fa265136f5bc31725897c7bc9) // vk.Q_ARITHMETIC.y
            mstore(add(_vk, 0x240), 0x07e396627afdeef31e7d480656e5511302a922816aab8d7822e2900ce272508e) // vk.QSORT.x
            mstore(add(_vk, 0x260), 0x0398a214d3ea2fa502716da3628f3a8815b0319b6415d2756edacf8e959a7f78) // vk.QSORT.y
            ...
            mstore(add(_vk, 0x2c0), 0x16c6f22cd92d3a694937d74015741ba49cd8fa23896d58e2ac7718217c17878d) // vk.Q_AUX.x
            mstore(add(_vk, 0x2e0), 0x081dfa12de145aea4a1b7a1b7f43a9ce62b87b8bb8bb020bbdc13856d27b80d7) // vk.Q_AUX.y
            mstore(add(_vk, 0x300), 0x2dea3379ea217d4cf132824d82a8ab41b845ed07dbca5cb180976bd299fe4941) // vk.SIGMA1.x
            mstore(add(_vk, 0x320), 0x052b97d3eb7f8fe58112d84cc6ad05347ab1272104df9ffda185d897d76c8d12) // vk.SIGMA1.y
            mstore(add(_vk, 0x340), 0x1997994ab9e863e54a2b3f98c8ead7771a69678248b4a83059d200778888aaed) // vk.SIGMA2.x
            mstore(add(_vk, 0x360), 0x195d51edf8f1f2b10337b2a8d00920ac33c0cf8a21e4399a85607ac2797aa213) // vk.SIGMA2.y
            mstore(add(_vk, 0x380), 0x00c818ac137b16cdbe0d7448ec09364b0a1bd5c63f416bee2576114ac7bd4f02) // vk.SIGMA3.x
            mstore(add(_vk, 0x3a0), 0x2419bdc7fa6e76ee2ad9b67f5ac4c7d83b0131850f6bea2ccf29a68b71d6feb8) // vk.SIGMA3.y
            mstore(add(_vk, 0x3c0), 0x2760cb14352a698c32e9cd2ac1e6e5a9505bc198f3f2183059bb7a2c8c6fe47d) // vk.SIGMA4.x
            mstore(add(_vk, 0x3e0), 0x15745ff3013dea3de262d999c9468eb943540cd4417c23b5a5ebfbdb0c68901f) // vk.SIGMA4.y
            ...
            mstore(add(_vk, 0x500), 0x1192f285c3d0392e800a88043b9db66560351bfe5423390d1662f253f787ef26) // vk.TABLE_TYPE.x
            mstore(add(_vk, 0x520), 0x2142cace217957884265a95c12dd22ea64ab9cdc9c956d3659e3fd66d52f65e9) // vk.TABLE_TYPE.y
            mstore(add(_vk, 0x540), 0x1b0d5568fe30900a9dff39f0d00a0c3bf85783b1a0649138be0195764f60b950) // vk.ID1.x
            mstore(add(_vk, 0x560), 0x09567dd53e7eafa25101ba06b608e34d1235ad8b0df3550c955f172221c8569d) // vk.ID1.y
            mstore(add(_vk, 0x580), 0x2b142ab910842dca07a03a6f55c4f69433c3590d9bf782915a1eed3f4d21cfb9) // vk.ID2.x
            mstore(add(_vk, 0x5a0), 0x0a6fc6006f8abd0e0c19cbc0f5d13ad783d4b76e6fb0fa4c61c8912845de9135) // vk.ID2.y
            mstore(add(_vk, 0x5c0), 0x15513c6ecc341c0319b643316347ce584b1fa662e5dce6444dc7745b480294ad) // vk.ID3.x
            mstore(add(_vk, 0x5e0), 0x2468630d463f587071a21427e413d755e9b78f6defba665efaae7dd35c549cb2) // vk.ID3.y
            mstore(add(_vk, 0x600), 0x2bf1a7578234ca06e417ec3d2e751bb1d7d165a1d372c4c16442d34e7db1ea1d) // vk.ID4.x
            mstore(add(_vk, 0x620), 0x1b5353c1df543d3d81227adcd0fe71cc455fd1743e900dde39a378f5d4c0bd1f) // vk.ID4.y
