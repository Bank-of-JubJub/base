// Verification Key Hash: a29a70b703fa2a435062f88f45b2add18500598cbd96b3582aae6fb8795f0d37
...
library UltraVerificationKey {
    function verificationKeyHash() internal pure returns(bytes32) {
        return 0xa29a70b703fa2a435062f88f45b2add18500598cbd96b3582aae6fb8795f0d37;
    }
    ...
    function loadVerificationKey(uint256 _vk, uint256 _omegaInverseLoc) internal pure {
        assembly {
            ...
            mstore(add(_vk, 0x80), 0x04910334062a5d42309cdccc7e3250fe05a0e5192be1786af4a601b9902dc8cf) // vk.Q1.x
            mstore(add(_vk, 0xa0), 0x216ff15dce62b8e5ed5d5fe3c6172e136c1230d2b1c7f351ba1e66533120da36) // vk.Q1.y
            mstore(add(_vk, 0xc0), 0x287ad0918327a3cb5c9662f245e8668380eb3f21e838f5dd16e8f83a9ecbcf02) // vk.Q2.x
            mstore(add(_vk, 0xe0), 0x196a8e3a1fbc412971cb495a75847ef3f53b418da8f72bab74ce8bb12b348f48) // vk.Q2.y
            mstore(add(_vk, 0x100), 0x286f420f9d5a8430fca0df0040ac0b23e2ed6a18058c2d3d6104b2d5b6e175eb) // vk.Q3.x
            mstore(add(_vk, 0x120), 0x2243303c16f03d533edbca43d684624623244e2dcafe707458f7745aca994110) // vk.Q3.y
            mstore(add(_vk, 0x140), 0x14132c291e66bc098e5975a60356770e818ed9016c9366cc2ab3256d06764c07) // vk.Q4.x
            mstore(add(_vk, 0x160), 0x2eacbcad11f6ea3a00505390d7f62e1c7708ca9eab8f1d00c47d7c5db1d9ef8d) // vk.Q4.y
            mstore(add(_vk, 0x180), 0x0160675f6e454583d2eb81313585fb479d7bcecbb35e447d23bb839d5179dcf3) // vk.Q_M.x
            mstore(add(_vk, 0x1a0), 0x190ba5be0d9dcbe2aa993ca76da3be7bca16302598f8975bcd48f4edcbc4c4a8) // vk.Q_M.y
            mstore(add(_vk, 0x1c0), 0x1552acc21b0e26e3fb5962f33910969625f5f743634737f59598fdf12af5280e) // vk.Q_C.x
            mstore(add(_vk, 0x1e0), 0x27b561bf36862704e1389a4e0dd3b891db3a6053593e3ce7a4565f3988273e85) // vk.Q_C.y
            mstore(add(_vk, 0x200), 0x1f6ee8981d062b8ed985dba30ef710b098406c3c96f813cf39713b3149ea6a40) // vk.Q_ARITHMETIC.x
            mstore(add(_vk, 0x220), 0x07b27a6c4fddcdbf7713f016c286d9215ff56603ba84e343fae22e220f45c6f6) // vk.Q_ARITHMETIC.y
            mstore(add(_vk, 0x240), 0x2ca87b3a6d586cd370c650336eee1e1eba6899bae795e8ada77633ff4464682e) // vk.QSORT.x
            mstore(add(_vk, 0x260), 0x099b61ca6396e3be251590f6132960a3735902173ca3157f4e48ea2f1a51f5cf) // vk.QSORT.y
            ...
            mstore(add(_vk, 0x2c0), 0x02afe8b2a6449b8958373c78d65f5bdcc64d520ad4573351f5423a2a065b3b8e) // vk.Q_AUX.x
            mstore(add(_vk, 0x2e0), 0x1a1fa9c52d21fc44e0879bc997140607d542e5d895ad9f91c29d86bbed528217) // vk.Q_AUX.y
            mstore(add(_vk, 0x300), 0x02c355da4e987f6a08520b19f77eda75461791490f955db9f2a0e5c364273269) // vk.SIGMA1.x
            mstore(add(_vk, 0x320), 0x17a4792b8a767d612087f8b40dbdbecf642d1e0401f8bbcc79965b05c6a80b09) // vk.SIGMA1.y
            mstore(add(_vk, 0x340), 0x19147f4bf33f8329e7f3ac2fb4a5eaf470597cfe79c84da447ba84f702b81deb) // vk.SIGMA2.x
            mstore(add(_vk, 0x360), 0x0df233782d524587c9cb4927ab0c9940ead018a0a189d132035cc9c5ce60dbdc) // vk.SIGMA2.y
            mstore(add(_vk, 0x380), 0x04310328e64f63575e837bb9a65f61747319e6de3475e2df6e5569abf42f65c3) // vk.SIGMA3.x
            mstore(add(_vk, 0x3a0), 0x04ea76abdde2dd6d0b64725567a52b1bdb9a62cc5d4b416188a4071b5c4e603f) // vk.SIGMA3.y
            mstore(add(_vk, 0x3c0), 0x24e06949667206f715bedbb1e0c3497a9f2b00dca3d476da542a5b9b5ddf9e28) // vk.SIGMA4.x
            mstore(add(_vk, 0x3e0), 0x0bbd9e02f3a3fb798266188ab84c54f8ed7bf82e7b0054b483a31adb24c40033) // vk.SIGMA4.y
            ...
            mstore(add(_vk, 0x500), 0x17894e46cc056c0aa74fd665dea4250d83e256c6d75889726175365c72c09f5e) // vk.TABLE_TYPE.x
            mstore(add(_vk, 0x520), 0x12480d7e78137d10577ded01320d31a612cead54423f0d45229152627ef96a58) // vk.TABLE_TYPE.y
            mstore(add(_vk, 0x540), 0x14bd914721a9fdc16c6f702b23e6601ac17d86e4d22e288ee6809a0e63a92ac6) // vk.ID1.x
            mstore(add(_vk, 0x560), 0x15d583d1a99e360eafa41d8ae2c65108d719f8ac67ab88130e15a8dec2fbb51d) // vk.ID1.y
            mstore(add(_vk, 0x580), 0x0f43e2df593a746aba262d5d18ce06f1ae0d4db2880e613b44d7351fc6507eba) // vk.ID2.x
            mstore(add(_vk, 0x5a0), 0x1201a474ed3b8350be0ed7167da7654cef79df768cc56b1c16520b05e5bc041c) // vk.ID2.y
            mstore(add(_vk, 0x5c0), 0x1276494f5efc697fc031aa66cbf13f9494a906a13717e78109251af2a55a1d93) // vk.ID3.x
            mstore(add(_vk, 0x5e0), 0x2485d34a224b8a39beed86c55081295f2977b14b69a49778c039c4d8f4bdc2b2) // vk.ID3.y
            mstore(add(_vk, 0x600), 0x04295400cc29c85dfb196ef79bd9ec85179b98022c07466ad71ee8ca247cabdf) // vk.ID4.x
            mstore(add(_vk, 0x620), 0x19597552867776af0cd317ec34126d2e009f791eadc7fb5884e44ddac7f5fa75) // vk.ID4.y
