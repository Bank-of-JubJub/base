  ...
  it("should process pending deposits", async function () {
    ...
    let inputs = {
      ...
      new_enc_balance_1: {
        ...
        C2x: 0x15f22eb9e5e68af082365afb12c83997d06514835e1a34cf787d3b65831a03a2n,
        C2y: 0x043495e2d574a451ed777f379c85fe3ac5230909f6aace57ff1900ebb74da265n,
      },
    };
    ...
    // TODO, get the correct encrypted deposit amount

    console.log(pendingDeposit);

    let res = await privateToken.write.processPendingDeposit([
      proof,
      txsToProcess,
      feeRecipient,
      recipient,
